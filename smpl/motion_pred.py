...
class motion_pred_dataset(Dataset):
    def __init__(self, path, input_frame, pred_frame, is_eval=False):
        self.total_frame = input_frame + pred_frame
    ...
    def get_single_npz(self, path):
        ...
        return motion[:self.input_frame], motion[self.pred_frame:]

    def __len__(self):
        return len(self.motions)

    def __getitem__(self, idx):
        print(self.motions[idx])
...
if __name__ == "__main__":
    ...
    dset = motion_pred_dataset(path="./", input_frame=160, pred_frame=80, is_eval=True)
    ...
    # npz_path = './amass_cmu/35_10_poses.npz'
    npz_path = './amass_cmu/49_08_poses.npz'
    ...
    while v.is_active:
        ...
        # smpl_model.translation = trans + [0.0, 1.0, 0.0]
